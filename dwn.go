...
func downloadViaAPI(client *whatsmeow.Client, v *events.Message, targetUrl, resolution string, isAudio bool) {
	...
	apiUrl := fmt.Sprintf("https://youtube-dwn.up.railway.app/api/download?url=%s&resolution=%s", targetUrl, resolution)
